...
<div className="container">
    <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top footer">
        <div className="col-md-4 d-flex align-items-center">
            <span className="footerTitle">&copy; 2021  Best Gift, Inc</span>
        </div>
        <ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
            <li className="ms-3"><span className="icons"><a href="https://www.facebook.com">
            ...
            <li className="ms-3"><span className="icons"><a href="https://www.instagram.com/">
            ...
            <li className="ms-3"><span className="icons"><a href="https://www.youtube.com">
